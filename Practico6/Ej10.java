...
class RBTree10<K extends Comparable<K>, V> {
     ...
     * 
     * @return true si la raíz es negra (o el árbol está vacío), false en caso
     *         contrario
     */
    ...
    private void printTree(RBNode10<K, V> node, String prefix, boolean isTail) {
        if (node != NIL) {
            System.out.println(prefix + (isTail ? "└── " : "├── ") +
                    ...
                    + " (p="
                    + (node.parent != null && node.parent != NIL && node.parent.key != null ? node.parent.key : "NIL")
                    + ")");
...
public class Ej10 {
    public static void main(String[] args) {
        ...
        java.util.List<RBTree10<Integer, String>> arboles = java.util.Arrays.asList(tree1, tree2, tree3, tree4, tree5,
                tree6);
